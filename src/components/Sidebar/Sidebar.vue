...
<template>
    <div class="sidebar w-[299px] shadow-lg min-h-screen relative bg-indigo-600">
        ...
        <h1 class="px-2 py-1 text-white rounded-xl text-center inline-block w-[48px] h-[48px] text-3xl font-bold bg-red-500">A</h1>
            <a href="/dashboard1" class="logo inline-block text-center ml-4 text-white text-4xl font-bold">Academy</a>
        </div>
        ...
        <div class="list mt-10">
            <a href="/dashboard1" id="links" class="ml-14 rounded-l-full list__item font-bold p-4 block my-2 text-yellow-500 hover:bg-white hover:text-balck duration-100">
            ...
            <div class="mt-20 ml-20 rounded-l-full font-bold p-4 block my-2 text-white hover:bg-white hover:text-black duration-100">
                <a href="/dashboard1" class="m-auto font-bold">Chiqish><i class='bx bx-log-out ms-20'></i></a></div>
    </div>
</template>
